...
<body>
    ...
    <br>
    <div style="box-sizing: border-box; margin-left: 1em; margin-right: 1em" id="demo" class="carousel slide" data-ride="carousel">
        ...
        <!-- The slideshow -->
        <div class="carousel-inner"style="box-sizing: border-box; margin: auto">
          <div class="carousel-item active" style="box-sizing: border-box; margin: auto">
            <img style="box-sizing: border-box; width: 100%" src="img/adult-advertisement-airport-1114376.jpg" alt="Los Angeles" width="1100" height="500">
          </div>
          <div class="carousel-item">
            <img style="box-sizing: border-box; width: 100%" src="img/advertisement-advertising-boutique-1051744.jpg" alt="Chicago" width="1100" height="500">
          </div>
          <div class="carousel-item">
            <img style="box-sizing: border-box; width: 100%" src="img/black-friday-buy-computer-34577.jpg" alt="New York" width="1100" height="500">
          </div>
        </div>
